    ...
    <div class="container">
      ...
      <div class="span12">
        ...
        <footer class="container">
          ...
          <p class="muted">
            <strong>Slug</strong> parte de um URL que identifica uma página usando palavras-chave
            legíveis. <small class="muted">(<a href="http://en.wikipedia.org/wiki/Clean_URL" title=
            "Clean URL - Wikipedia, the free encyclopedia" target="_blank">Wikipédia</a>)</small>
          </p>
        </footer>
